...
/** Neutralize react-remove-scroll padding (html already uses scrollbar-gutter: stable). */
function ScrollLockShiftFix() {
  React.useEffect(() => {
...
>(({ className, style, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn("stackfix-modal-overlay", className)}
    style={style}
    {...props}
  />
));
...
>(({ className, style, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        "grid w-[calc(100%-2rem)] max-w-lg gap-4 rounded-xl border border-border/60 bg-white p-6 shadow-xl duration-200",
        "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=open]:opacity-100 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
        className,
      )}
      {...props}
    >
